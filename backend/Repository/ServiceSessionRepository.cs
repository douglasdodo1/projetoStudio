...
public class ServiceSessionRepository : IServiceSessionRepository
{
    ...
    {
        ServiceSessionModel AddedServiceSession = await _db.SessionService.AddAsync(serviceSession);
    ...
    {
        findedServiceSession.IdConsulta = serviceSessionToUpdate.IdConsulta;
        findedServiceSession.IdServico = serviceSessionToUpdate.IdServico;
        await _db.SaveChangesAsync();
